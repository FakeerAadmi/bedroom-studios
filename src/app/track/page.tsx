...
// Canvas-based image resizer and quality compressor to optimize payload sizing
function compressImage(base64Str, maxWidth = 1000, quality = 0.7) {
  return new Promise((resolve) => {
    ...
    img.onerror = () => resolve(base64Str); // Fallback to raw on failure
  });
}

// Removed seeded order generator
...
export default function OrderTrackerPage() {
  ...
  // Handle progress photo upload per stage
  const handlePhotoUpload = (stageIndex, e) => {
    ...
    reader.onloadend = async () => {
      ...
      const updated = {
        ...uploadedPhotos,
        [stageIndex]: compressedBase64
      };
      setUploadedPhotos(updated);
      localStorage.setItem(`bs_photos_${orderNum}`, JSON.stringify(updated));
    };
    reader.readAsDataURL(file);
  };

  // Clear a photo
  const handleClearPhoto = async (stageIndex) => {
    const updated = { ...uploadedPhotos };
    delete updated[stageIndex];
    setUploadedPhotos(updated);
    localStorage.setItem(`bs_photos_${orderNum}`, JSON.stringify(updated));
  };
  ...
  // Manufacturing progress stages definition
  const stages = [
    {
            ...
            <form onSubmit={handleLogin} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-2">
                  {/* Fixed country-code style Prefix Box */}
          ...
          >
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_2fr]">
              ...
              <div className="space-y-6">
                ...
                {/* Workshop Discussion / Live Build Chat */}
